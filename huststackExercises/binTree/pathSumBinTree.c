/*
Tìm một đường đi từ gốc tới lá có tổng là một số cho trước. Nếu tồn tại đường đi trả về 1, 
nếu không trả về 0.
Đầu vào gồm dòng đầu là n là số nút trong cây. N dòng tiếp theo mỗi dòng chứa nút cha, 
nút con trái và nút con phải (-1 nếu NULL). Dòng thứ  n+2 chứa giá trị tổng mong muốn.
*/
